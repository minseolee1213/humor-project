...
5. **Important**: Add the redirect URL to Google OAuth settings:
   - Production: `https://humor-project-vb4r.vercel.app/auth/callback`
...
NEXT_PUBLIC_SITE_URL=https://humor-project-vb4r.vercel.app
```
...
2. **Production**:
   After deploying, visit `https://humor-project-vb4r.vercel.app/images`

## Notes

- The redirect URI is exactly `/auth/callback` (no query parameters)
- OAuth redirect URL is: `https://humor-project-vb4r.vercel.app/auth/callback` (production)
